...
namespace Test
{
    ...
    {
        public static Attack.Source AtkSource = new Attack.Source(0);
        ...
        public static Push.Source PushSource = new Push.Source(0);
        public static Push BasePush = new Push
        {
            power = 2,
            pierce = 1,
        ...
        public static Layer TargetedLayer =
            Layer.DROPPED
            | Layer.GOLD
            | Layer.MISC
            | Layer.PROJECTILE
            ...
            | Layer.TRAP
            | Layer.WALL;
        public static Layer SkipLayer = 0;

        public static IProvideTargets<AtkTarget, Attack> targetProvider =
            TargetProvider.CreateMulti<AtkTarget, MultiTarget<AtkTarget, Attack>, Attack>(
