...
namespace Hopper.Core.Components
{
    ...
    ///
    /// In this case the export is considered "static", since it is not suppoed to be hooked up
    /// at a different behavior at runtime, e.g. status effects and item effects.
    ///
    ...
    /// With this attribute, it is possible to use this attribute outside behavior classes.
    /// 
    /// The last field specifies the priority rank given to the attribute. 
